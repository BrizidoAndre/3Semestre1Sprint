...
import { HideItems, InputContainer, WithoutHeader } from "../../components/container/style"
...
const SelectData = ({ navigation }) => {
    ...
    return (
        <>
            ...
            <ConfirmAppointment item={item} hideModal={hideModal} setHideModal={setHideModal} navigation={navigation} />
        </>
    )
}
